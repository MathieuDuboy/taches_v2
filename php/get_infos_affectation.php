...
<form id="form_detail_affectation">
  <input id="detail_phase" name="detail_phase"  type="hidden" value="<?php
    echo $row["phase"];
?>">
  <input id="detail_id_projet" name="detail_id_projet"  type="hidden" value="<?php
    echo $_GET["id_projet"];
?>">
  <input id="detail_id_affectation" name="detail_id_affectation"  type="hidden" value="<?php
    echo $id_affectation;
?>">
  ...
  <div id="detail_step3_affectation">
    <div class="form-group">
      <label for="date_max">Date Max : <?php
    echo $row["date_max"];
?></label>
      <input class="form-control" id="detail_date_max" name="detail_date_max" value="<?php
    echo $row["date_max"];
?>" type="text">
    </div>
    <div class="form-group">
