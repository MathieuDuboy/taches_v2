...
//
$sql    = "INSERT INTO `projets` (`id`, `nom`, `date_debut`, `date_installation`, `id_manager`, `manager`, `id_client`, `client`, `id_tech`, `tech`, `etat`, `last_modification`)
VALUES (NULL, '" . $nom . "', '" . $date_debut . "', '" . $date_installation . "', '" . $id_manager . "', '" . $manager . "', '" . $id_client . "','" . $client . "', '" . $id_tech . "','" . $tech . "', 'Initialisé', '" . $now . "');";
