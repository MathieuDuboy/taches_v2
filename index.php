      ...
      <tbody>
        ...
        while($row = $result->fetch_array()) {
          ...
          <tr>
            ...
            <td><?php $tab_client = explode("/", $client); $entreprise = explode(" : ", $tab_client[1]); echo $entreprise[0]; ?></td>
                 ...
                 ?> <select class="custom-select" id="tache" name="tache">
                    ...
                    <?php
                     while($row = mysqli_fetch_array($result)) {
                       if($row['nom_sous_tache'] != '') {
                        ?> <option value="<?php echo $row['id']; ?>">🏴 <?php echo $row['nom_tache']; ?></option><?php
                       }
                       else {
                        ?> <option value="<?php echo $row['id']; ?>"><?php echo $row['nom_tache']; ?></option><?php
                       }
